...
<p class="body-text">
    ...
    <span class="underline-field">&nbsp;{{ strtoupper($resident?->full_name ?? '') }}&nbsp;</span>,
    of legal age, {{ $resident?->civil_status ?? '' }}, Filipino citizen, and a
    resident of
    @if($household)
        {{ $household->full_address }},
    @endif
    Barangay Caranas, Motiong, Samar, belongs to an <strong>indigent family</strong> and is one of the
    less fortunate residents in this barangay. His/Her family does not have sufficient means to support the
...
<div class="footer-fields">
    <table>
        <tr><td>O.R. No.</td><td><span class="field-line">&nbsp;{{ $document->or_number ?? 'N/A (Free)' }}&nbsp;</span></td></tr>
